...
function Passaro(alturaJogo) {
    ...
    this.animar = () => {
        ...
        this.setY(Math.max(Math.min(novoY, alturaMaxima), 0))
    }
...
function estaoSobrepostos(elementoA, elementoB) {
    ...
    vertical && console.log(a.top + a.height, b.top, b.top + b.height, a.top)
...
// const barreiras = new Barreiras(560, 1200, 200, 400)
